...
More information can be found in the :doc:`Embed Documentation </fxstcloud/embed>`.

.. literalinclude:: ../../examples/embed_templates.py
   :language: python

1. Pass a string to the :meth:`~fxstcloud.emb.error` method to send an error message.
